        ...
        <div class="card-body p-3">
            <div class="row gx-4 d-flex justify-content-between">
                <div class="col-12 col-md-auto d-flex align-items-center mb-3 mb-md-0">
                    ...
                    <h5 class="mb-0 mt-0"><strong>Rekapan Penjualan Bulanan</strong></h5>
                </div>
                <div class="col-12 col-md-auto d-flex align-items-center">
                    <form action="{{ route('index.rekapan_bulanan') }}" method="GET" enctype="multipart/form-data">
                        @csrf
                        <div class="row gx-2">
            ...
            <div class="card-body">
                <div class="row align-items-center">
                    ...
                    <div class="col text-end">
                        <a href="{{ route('print.bulanan') }}" class="btn btn-primary" target="_blank" data-bs-toggle="tooltip" data-bs-placement="right" title="Print Data"><i class="ri-printer-fill"></i></a>
                    </div>
                ...
                <div class="table-responsive">
                    ...
                    <table class="table table-striped table-bordered">
                        ...
                        <tbody>
                            @forelse ($bulanan as $index => $data)
                                <tr>
                                    <td>{{ $index + $bulanan->firstItem() }}</td>
                ...
                <div class="col-auto">
                    <nav aria-label="Page navigation example">
                        <ul class="pagination d-flex justify-content-end">
                            {{ $bulanan->appends(['search' => $searchKeyword, 'bulan' => $selectedMonth])->links() }}
                        </ul>
                    </nav>
                </div>
            </div>
