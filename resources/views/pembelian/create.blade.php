        ...
        <div class="row gx-4 d-flex justify-content-between">
            ...
            <div class="col-auto d-flex align-items-center">
                <ul class="nav nav-pills nav-fill p-1" role="tablist">
                    <li class="nav-item">
                        <span class="display-6" id="masteruangmodals">{{ $formattedmasteruangs }}</span>
                    </li>
                </ul>
            </div>
        </div>
...
<form action="{{ route('store.pembelian') }}" method="POST" enctype="multipart/form-data">
    @csrf
    <div class="card mb-2">
        <div class="card-body">
            ...
            <div class="row">
                <div class="col-md-6 mb-4">
                    ...
                    <div class="row mb-2">
                        <div class="col-md-12">
                            <input type="hidden" class="form-control" name="total_bonus" id="total_bonus">
                        </div>
                    </div>
                </div>
                <div class="col-md-6 mb-4">
                    <div
                        style="border: 1px solid #ccc; padding: 10px; width: 100%; border-radius: 10px; display: flex; flex-direction: column;">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group mb-2">
                                        <div class="input-group">
                                            ...
                                            <input type="number" class="form-control" placeholder="Pembayaran"
                                                id="pembayaran" name="pembayaran" aria-label="Pembayaran"
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            <span class="input-group-text" id="basic-addon1">Rp</span>
                                            <input type="text" class="form-control" name="kembalian" id="kembalianInput"
                        ...
                        <table class="table align-items-center mb-0" id="listproduk">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center text-dark"> <span class="badge bg-success">Jumlah
                                            Produk</span></th>
                                    <th class="text-center text-dark"> <span class="badge bg-success">Total Harga</span>
                                    </th>
                                    <th class="text-center text-dark"> <span class="badge bg-success">Bonus</span></th>
