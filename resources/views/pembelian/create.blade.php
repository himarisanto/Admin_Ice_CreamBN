                            ...
                            <div class="col-md-12">
                                <select class="form-control select2" id="kode_produk" name="kode_produk" required>
                                    ...
                                    @foreach ($produks as $ices)
                                        <option value="{{ $ices->kode_produk ?? '-' }}" data-nama-produk="{{ $ices->nama_produk ?? '-' }}" data-harga-beli="{{ $ices->harga_beli }}" data-gambar="{{ $ices->gambar_produk ?? '-' }}" data-stok-produk="{{ $ices->stok ?? '-' }}">
